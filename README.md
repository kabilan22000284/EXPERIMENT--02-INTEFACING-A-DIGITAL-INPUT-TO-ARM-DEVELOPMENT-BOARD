...
## STM 32 CUBE PROGRAM :
```
#include "main.h" #include "stdio.h" #include "stdbool.h" bool pb;

int main(void) {

while (1) { pb=HAL_GPIO_ReadPin(GPIOC,GPIO_PIN_13); if(pb==0) { HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_SET); HAL_Delay(100); HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_RESET); HAL_Delay(100);
